...
class Q1Q2MobilePrinter {
  ...
  Future<void> printColumn(List<String> text,
      {required Int32List columnWidth,
      required Int32List columnAlignment,
      bool isLast = false}) async {
    if (columnWidth == null) {
      List<int> columnWidthPrepare = [];
    ...
    if (columnAlignment == null) {
      List<int> prepareColumnAlignment = [];
